...
def test_strategy11_probability_skip_records_best_probability_diagnostics_when_probability_is_below_floor():
    now = datetime(2026, 4, 30, 1, 2, 0, tzinfo=timezone.utc)
    window = MarketWindow(
        event_id="e1",
        market_id="m1",
    ...
    assert decision.side is None
    assert decision.reason == "strategy11_probability_too_low"
